...
from app.identity.application.exceptions import UsernameAlreadyExistsError
from app.identity.infrastructure.security.password import hash_password
from app.identity.domain.value_objects.password_hash import PasswordHash
from app.identity.domain.enums.user_role import UserRole
