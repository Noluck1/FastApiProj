...
from app_auth.identity.application.exceptions import UsernameAlreadyExistsError
from app_auth.identity.infrastructure.security.password import hash_password
