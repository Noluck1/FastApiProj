...
from backend.app_books.books.application.exceptions import (
    NotFoundError, 
    BookAccessDeniedError, 
    FavoriteNotFoundError, 
    FavoriteAlreadyExistsError,
    IdentityServiceUnvailableError,
)
from backend.app_books.books.domain.exceptions import InvalidBookTitleError, InvalidBookDescriptionError, BookAlreadyDeletedError
...
def register_books_exception_handlers(
    ...
    app.add_exception_handler(
        IdentityServiceUnvailableError,
        identity_service_unavaileble_handler,
    )
...
async def identity_service_unavaileble_handler(
    _request: Request,
    _exc: IdentityServiceUnvailableError,
) -> JSONResponse:
    response = error(
        message="Identity service is unavaileble"
    )
