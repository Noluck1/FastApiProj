...
from backend.app_books.books.infrastructure.persistence.mappers.book.book_mapper import book_to_domain, book_to_orm, apply_book_to_orm
    ...
    async def get_books(
        ...
        if filters.author_id is not None:
            where_clauses.append(
                BooksOrm.author_id == filters.author_id
            )
