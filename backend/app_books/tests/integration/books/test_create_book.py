...
from backend.app_books.books.application.handlers.books.command.create_book import (
    CreateBookCommand,
    CreateBookHandler,
)
...
from backend.app_books.books.infrastructure.persistence.repositories.book.book_repository import (
    BookRepository,
)
