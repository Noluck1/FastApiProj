...
from backend.app_auth.identity.application.handlers.commands.register_user import RegisterUserHandler
...
from backend.app_auth.identity.application.handlers.commands.login_user import LoginUserHandler
from backend.app_auth.identity.application.handlers.commands.refresh_session import RefreshSessionHandler
from backend.app_auth.identity.application.handlers.commands.logout_user import LogoutUserHandler
from backend.app_auth.identity.application.handlers.queries.get_me import GetCurrentUserHandler
...
from backend.app_auth.identity.application.handlers.commands.update_full_name import UpdateFullNameHandler
...
class AuthHandlerProvider(Provider):
    ...
    @provide
    def update_full_name_handler(
        self,
        repository: IUserRepository,
        uow: IUnitOfWork,
    ) -> UpdateFullNameHandler:
        return UpdateFullNameHandler(
            repository=repository,
            uow=uow,
        )