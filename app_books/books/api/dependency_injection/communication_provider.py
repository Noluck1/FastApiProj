...
from app_books.books.application.ports.outbound.i_identity_gateway import IIdentityGateway
from app_books.books.config.settings import books_settings
from app_books.books.infrastructure.clients.identity_http_gateway import IdentityHttpGateway
